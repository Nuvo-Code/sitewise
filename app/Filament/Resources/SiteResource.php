        ...
        return $form
            ->schema([
                ...
                Forms\Components\Section::make('🌐 Site Information')
                    ->description('Basic information and identity of your website')
                ...
                // SEO & Meta Settings
                Forms\Components\Section::make('🔍 SEO & Meta Settings')
                ...
                Forms\Components\Section::make('📱 Social Media & Contact')
                ...
                // Appearance & Branding
                Forms\Components\Section::make('🎨 Appearance & Branding')
                    ->description('Visual appearance and branding settings')
                ...
                Forms\Components\Section::make('🔧 Maintenance & Advanced')
                    ->description('Maintenance mode and advanced settings')
